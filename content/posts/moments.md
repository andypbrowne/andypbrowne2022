+++
type = ""
description = "Short text and images inspired by the now defunct hi.co. These quick sketches are intended to be expanded upon and inspire future work"
title = "Moments"
date = "2016-08-12T12:42:00-00:00"
+++

<h2 class="serif-hero">Short text and images inspired by the now defunct hi.co. These quick sketches are quick meditations in the spirit of fugitive ground</h2> 

<div class="dark-bg" style="
    background: url(img/blog/57ae6ac37480b42b138b46fc.jpg) no-repeat center; 
...
<div class="dark-bg" style="
    background: url(img/blog/firewatch.jpg) no-repeat center bottom; 
    background-size:cover; 
    background-color:#333;
    padding: 50vh 10% 10vh;">
   <p class="type underline">August 12, 2016 &dash; Moment</p>
    ...
    <p class="type">#web #development</p>
</div>

<div class="dark-bg" style="
    background: url(img/blog/57ae8ecc7480b42b138b47d5.jpg) no-repeat center bottom; 
    background-size:cover; 
    background-color:#333;
    padding: 50vh 10% 10vh;">
   <p class="type underline">August 12, 2016 &dash; Moment</p>
    ...
    <p><em>
      * twilight may refer to civil, nautical or astronomical variety depending on your social or terrestrial condition</em>
    </p>
    <p class="type">#meditation #creativity</p>
</div>